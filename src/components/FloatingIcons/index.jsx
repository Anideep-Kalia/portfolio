...
const FloatingIcons = () => {
  return (
    <div className="z-[10] flex justify-between w-full items-center my-14">
      <a href="mailto:anideepkalia@gmail.com" className="social">
        <motion.span
      ...
      <a href="https://github.com/Anideep-Kalia" target="_blank" className="social">
        <motion.span
          animate={{ opacity: 1, scale: 1 }}
          initial={{ opacity: 0, scale: 0 }}
          transition={{
      ...
      <a
        href="https://linkedin.com/in/anideep-kalia-aa9ba0255/"
        target="_blank"
        className="social"
      >
        <motion.span
